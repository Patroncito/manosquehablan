...
struct QuizCalendarioView : View {
    ...
    //number of question
    @State var i : Int = 0
    let suffleQuiz = myQuizSuffle(data: quizCalendario)
        ...
        VStack{
            VStack(spacing: 15){
                ...
                if(self.i < suffleQuiz.count){
                    ...
                    FinalViewCalendario(score: score, scoreTotal: suffleQuiz.count)
