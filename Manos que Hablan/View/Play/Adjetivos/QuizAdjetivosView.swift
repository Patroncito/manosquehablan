...
struct QuizAdjetivosView : View {
    ...
    //number of question
    @State var i : Int = 0
    let suffleQuiz = myQuizSuffle(data: quizAdjetivos)
        ...
        VStack{
            VStack(spacing: 15){
                ...
                if(self.i < suffleQuiz.count){
                    ...
                    FinalViewAdjetivos(score: score, scoreTotal: suffleQuiz.count)
