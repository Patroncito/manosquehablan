...
struct QuizFrutasyVerdurasView : View {
   ...
   //number of question
   @State var i : Int = 0
   let suffleQuiz = myQuizSuffle(data: quizFrutasyVerduras)
       ...
       VStack{
           VStack(spacing: 15){
               ...
               if(self.i < suffleQuiz.count){
                   ...
                   FinalViewFrutasyVerduras(score: score, scoreTotal: suffleQuiz.count)
