//
//  QuizAnimalesView.swift
//  Manos que Hablan
//
//  Created by Fermin Alfonso Bañuelos Patrón on 10/05/23.
//
...
struct QuizAnimalesView : View {
    ...
    //number of question
    @State var i : Int = 0
    let suffleQuiz = myQuizSuffle(data: quizAnimales)
        ...
        VStack{
            VStack(spacing: 15){
                ...
                if(self.i < suffleQuiz.count){
                    ...
                    FinalViewAnimales(score: score, scoreTotal: suffleQuiz.count)
