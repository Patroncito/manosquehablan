...
struct QuizAlimentosView : View {
    ...
    //number of question
    @State var i : Int = 0
    let suffleQuiz = myQuizSuffle(data: quizAlimentos)
        ...
        VStack{
            VStack(spacing: 15){
                ...
                if(self.i < suffleQuiz.count){
                    ...
                    FinalViewAlimentos(score: score, scoreTotal: suffleQuiz.count)
