//
//  QuizRepublicaMexicanaView.swift
//  Manos que Hablan
//
...
struct QuizRepublicaMexicanaView : View {
   ...
   //number of question
   @State var i : Int = 0
   let suffleQuiz = myQuizSuffle(data: quizRepublicaMexicana)
       ...
       VStack{
           VStack(spacing: 15){
               ...
               if(self.i < suffleQuiz.count){
                   ...
                   FinalViewRepublicaMexicana(score: score, scoreTotal: suffleQuiz.count)
