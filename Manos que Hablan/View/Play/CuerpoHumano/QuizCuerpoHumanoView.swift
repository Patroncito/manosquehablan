...
struct QuizCuerpoHumanoView : View {
   ...
   //number of question
   @State var i : Int = 0
   let suffleQuiz = myQuizSuffle(data: quizCuerpoHumano)
       ...
       VStack{
           VStack(spacing: 15){
               ...
               if(self.i < suffleQuiz.count){
                   ...
                   FinalViewCuerpoHumano(score: score, scoreTotal: suffleQuiz.count)
